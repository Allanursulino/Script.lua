...
updateText.Text = "The script is being updated and will be back online soon!"
...
-- Garante que a GUI fique sempre centralizada, mesmo se a tela mudar de tamanho
game:GetService("RunService").RenderStepped:Connect(function()
    -- A GUI já está centralizada pelo AnchorPoint e Position
    -- Esta função garante que se mantenha centralizada durante redimensionamentos
end)
